...
rgcw.L["profile_create_button"] = "Create new Profile"
rgcw.L["profile_load_button"] = "Load"
rgcw.L["profile_rename_button"] = "Rename"
rgcw.L["profile_delete_button"] = "Delete"
rgcw.L["profile_reset_button"] = "Reset to defaults"
...
rgcw.L["profile_active_suffix"] = "%s (active)"
rgcw.L["profile_load_confirm"] =
  "Load profile \"%s\"? Your current settings stay saved in \"%s\", then the UI reloads."
rgcw.L["profile_delete_confirm"] = "Delete profile \"%s\"?"
rgcw.L["profile_delete_active_confirm"] =
  "Delete profile \"%s\"? It is the active profile - \"%s\" takes over your settings, then the UI reloads."
rgcw.L["profile_reset_confirm"] =
  "Reset profile \"%s\" to the factory settings?|n|nEvery option goes back to its default - the tracked "
  .. "cooldowns per category and side, the worst case and override values, the window options and the "
  .. "positions of every surface - then the UI reloads."
rgcw.L["profile_create_success"] = "Created profile \"%s\" - it is now active"
...
rgcw.L["profile_error_default_cannot_be_overwritten"] = "\"%s\" is a reserved profile name"
