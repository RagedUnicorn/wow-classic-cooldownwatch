...
rgcw.L["window_lock_friendly_proximity_cooldown_window"] = "Lock Friendly Proximity Cooldown Window"
rgcw.L["window_lock_friendly_proximity_cooldown_window_tooltip"] = "Prevents Friendly Proximity "
  .. "Cooldown Window frame from being moved"
