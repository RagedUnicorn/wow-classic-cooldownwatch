...
if (GetLocale() == "deDE") then
  ...
  rgcw.L["profile_create_button"] = "Neues Profil erstellen"
  rgcw.L["profile_load_button"] = "Laden"
  rgcw.L["profile_rename_button"] = "Umbenennen"
  rgcw.L["profile_delete_button"] = "Löschen"
  rgcw.L["profile_reset_button"] = "Auf Standard zurücksetzen"
  ...
  rgcw.L["profile_active_suffix"] = "%s (aktiv)"
  rgcw.L["profile_load_confirm"] = "Profil \"%s\" laden? Deine aktuellen Einstellungen bleiben in \"%s\" "
    .. "gespeichert, danach wird die Benutzeroberfläche neu geladen."
  rgcw.L["profile_delete_confirm"] = "Profil \"%s\" löschen?"
  rgcw.L["profile_delete_active_confirm"] = "Profil \"%s\" löschen? Es ist das aktive Profil - \"%s\" übernimmt "
    .. "deine Einstellungen, danach wird die Benutzeroberfläche neu geladen."
  rgcw.L["profile_reset_confirm"] = "Profil \"%s\" auf die Werkseinstellungen zurücksetzen?|n|nJede Option geht "
    .. "auf ihren Standardwert zurück - die verfolgten Abklingzeiten pro Kategorie und Seite, die Worst-Case- "
    .. "und Überschreibungswerte, die Fensteroptionen und die Positionen aller Anzeigen - danach wird die "
    .. "Benutzeroberfläche neu geladen."
  rgcw.L["profile_create_success"] = "Profil \"%s\" erstellt - es ist jetzt aktiv"
  ...
  rgcw.L["profile_error_default_cannot_be_overwritten"] = "\"%s\" ist ein reservierter Profilname"
